package com.icss.xing.controller;

import com.icss.xing.bean.GirdBean;
import com.icss.xing.entity.TexpressRecord;
import com.icss.xing.dao.TcourierDao;
import com.icss.xing.dao.TexpressCabinetDao;
import com.icss.xing.dao.TexpressRecordDao;
import com.icss.xing.entity.Tcourier;
import com.icss.xing.entity.TexpressCabinet;
import com.icss.xing.service.CodeService;
...
public class ExController {
    ...
    public GirdBean saveBox(TexpressCabinet texpressCabinet){
        ...
        if (!texpressCabinet.getExState().equals("使用中")){
            ...
            return new GirdBean(0,"快递添加成功！",null,0 );
        }else{
            return new GirdBean(0,"注意，该藏柜已被使用，请选择其他存储柜！",null,0 );
        }
    }
